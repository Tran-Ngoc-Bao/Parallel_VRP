...
MPINP="${NUM_WORKERS:-6}"
ADAPTIVE_ITERATIONS_VALUE="${ADAPTIVE_ITERATIONS:-10}"
ADAPTIVE_PULL_ELITE_SEGMENTS_VALUE="${ADAPTIVE_PULL_ELITE_SEGMENTS:-4}"
ELITE_PULL_STRATEGY_VALUE="${ELITE_PULL_STRATEGY:-rank}"
...
RANDOMIZE_WORKER_HYPERPARAMS_VALUE="$([ "${RANDOMIZE_WORKER_HYPERPARAMS:-1}" = "1" ] && echo true || echo false)"
